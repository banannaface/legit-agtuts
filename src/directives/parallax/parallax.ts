...
export class ParallaxDirective {
  ...
  ngOnInit(){
    ...
    this.divinfo = cnt.getElementsByClassName('main-cnt')[0];
    ...
    this.re.setElementStyle(this.divinfo,'position','absolute');
  }
  ...
  update(ev){
    if(ev.scrollTop>0){
      this.transamnt=ev.scrollTop/2; 
    }
    this.re.setElementStyle(this.header,'webkitTransform','translate3d(0,'+ this.transamnt +'px,0)scale(1,1)')
  }
}
